        ...
        const fetchDonations = async () => {
            try {
                const [totalRes, byCauseRes, lastDonationsRes] = await Promise.all([
                    axios.get('https://sahayata-backend-akk9.onrender.com/api/donations/total'),
                    axios.get('https://sahayata-backend-akk9.onrender.com/api/donations/by-cause'),
                    axios.get('https://sahayata-backend-akk9.onrender.com/api/donations/last-5'), // New endpoint for last donations
                ]);
